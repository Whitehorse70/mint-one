var Swiper = function () {
      ...
      A = e => {
         ...
         if (e.params.rewind || e.params.loop)
            for (let a = i - t; a <= r + t; a += 1) {
               ...
               for (let a = Math.max(i - t, 0); a <= Math.min(r + t, s - 1); a += 1) a !== i && (a > r || a < i) && z(e, a)
      };
   ...
   function D(e) {
      ...
      if (a >= 0 && s.evCache.splice(a, 1), ["pointercancel", "pointerout", "pointerleave", "contextmenu"].includes(e.type) && (!["pointercancel", "contextmenu"].includes(e.type) || !t.browser.isSafari && !t.browser.isWebView)) return;
      const {
         params: i,
         touches: r,
         rtlTranslate: o,
      ...
      if (m > i.longSwipesMs) {
         ...
         !t.navigation || p.target !== t.navigation.nextEl && p.target !== t.navigation.prevEl ? ("next" === t.swipeDirection && t.slideTo(null !== v ? v : f + y), "prev" === t.swipeDirection && t.slideTo(null !== w ? w : f)) : p.target === t.navigation.nextEl ? t.slideTo(f + y) : t.slideTo(f)
      }
   }
   ...
   const B = (e, t) => {
         ...
         r[d]("pointerdown", e.onTouchStart, {
            ...
            passive: !0
         }), (i.preventClicks || i.preventClicksPropagation) && r[d]("click", e.onClick, !0), i.cssMode && n[d]("scroll", e.onScroll), i.updateOnWindowResize ? e[c](l.ios || l.android ? "resize orientationchange observerUpdate" : "resize observerUpdate", $, !0) : e[c]("observerUpdate", $, !0), r[d]("load", e.onLoad, {
            capture: !0
         })
      },
   ...
   const F = {
         ...
         update: {
            ...
            updateActiveIndex: function (e) {
               ...
               p = t.virtual && i.virtual.enabled && i.loop ? c(d) : t.slides[d] ? parseInt(t.slides[d].getAttribute("data-swiper-slide-index") || d, 10) : d, Object.assign(t, {
                  ...
                  previousIndex: r,
                  activeIndex: d
               }), t.initialized && A(t), t.emit("activeIndexChange"), t.emit("snapIndexChange"), (t.initialized || t.params.runCallbacksOnInit) && (n !== p && t.emit("realIndexChange"), t.emit("slideChange"))
            },
         ...
         transition: {
            ...
            transitionStart: function (e, t) {
               ...
               a.cssMode || (a.autoHeight && s.updateAutoHeight(), I({
                  swiper: s,
                  runCallbacks: e,
                  direction: t,
                  step: "Start"
            ...
            transitionEnd: function (e, t) {
               ...
               s.animating = !1, a.cssMode || (s.setTransition(0), I({
                  swiper: s,
                  runCallbacks: e,
                  direction: t,
                  step: "End"
         ...
         events: {
            attachEvents: function () {
               ...
               e.onTouchStart = k.bind(e), e.onTouchMove = O.bind(e), e.onTouchEnd = D.bind(e), s.cssMode && (e.onScroll = H.bind(e)), e.onClick = G.bind(e), e.onLoad = X.bind(e), Y || (t.addEventListener("touchstart", N), Y = !0), B(e, "on")
            },
   ...
   class j {
      constructor() {
         ...
         const d = c({}, q, o);
         return l.params = c({}, d, _, t), l.originalParams = c({}, l.params), l.passedParams = c({}, t), l.params && l.params.on && Object.keys(l.params.on).forEach(e => {
   ...
   const re = [function (e) {
      ...
      function u() {
         ...
         p.forEach((e, r) => {
            if ("fraction" === s.type && (e.querySelectorAll(U(s.currentClass)).forEach(e => {
               ...
               let n = 1,
                  l = 1;
               "horizontal" === i ? n = r : l = r, e.querySelectorAll(U(s.progressbarFillClass)).forEach(e => {
      ...
      const i = "[data-swiper-parallax], [data-swiper-parallax-x], [data-swiper-parallax-y], [data-swiper-parallax-opacity], [data-swiper-parallax-scale]",
         r = (e, s) => {
            ...
            null != o && (p += ` scale(${o-(o-1)*(1-Math.abs(s))})`), c && null != c && (p += ` rotate(${c*s*-1}deg)`), e.style.transform = p
         },
         n = () => {
            const {
               el: e,
      ...
      function M(e) {
         ...
         if (f.minX = Math.min(m.slideWidth / 2 - a / 2, 0), f.maxX = -f.minX, f.minY = Math.min(m.slideHeight / 2 - i / 2, 0), f.maxY = -f.minY, f.touchesCurrent.x = u.length > 0 ? u[0].pageX : e.pageX, f.touchesCurrent.y = u.length > 0 ? u[0].pageY : e.pageY, Math.max(Math.abs(f.touchesCurrent.x - f.touchesStart.x), Math.abs(f.touchesCurrent.y - f.touchesStart.y)) > 5 && (t.allowClick = !1), !f.isMoved && !p) {
      ...
      a("beforeInit", () => {
         ...
         t.params.a11y.enabled && (() => {
            ...
            const a = t.wrapperEl,
               r = e.id || a.getAttribute("id") || "swiper-wrapper-" + (void 0 === (l = 16) && (l = 16), "x".repeat(l).replace(/x/g, () => Math.round(16 * Math.random()).toString(16)));
            var l;
            ...
            u = n(u), m = n(m), u && u.forEach(t => b(t, r, e.nextSlideMessage)), m && m.forEach(t => b(t, r, e.prevSlideMessage)), v() && (Array.isArray(t.pagination.el) ? t.pagination.el : [t.pagination.el]).forEach(e => {
         ...
         t.params.a11y.enabled && function () {
            ...
            g() && t.pagination.bullets.forEach(s => {
               t.params.pagination.clickable && (l(s), t.params.pagination.renderBullet || (d(s, "button"), p(s, e.paginationBulletMessage.replace(/\{\{index\}\}/, w(s) + 1)))), s.matches(U(t.params.pagination.bulletActiveClass)) ? s.setAttribute("aria-current", "true") : s.removeAttribute("aria-current")
            })
         }()
      }), a("destroy", () => {
         t.params.a11y.enabled && function () {
      ...
      const i = (e, s) => {
         ...
         a || (a = ie("flip", e, t.isHorizontal() ? "left" : "top")), i || (i = ie("flip", e, t.isHorizontal() ? "right" : "bottom")), a && (a.style.opacity = Math.max(-s, 0)), i && (i.style.opacity = Math.max(s, 0))
      };
      te({
         effect: "flip",
         swiper: t,
      ...
      s({
         ...
         setTranslate: () => {
            ...
            for (let e = 0, t = a.length; e < t; e += 1) {
               ...
               if (se(0, t).style.transform = b, t.style.zIndex = 1 - Math.abs(Math.round(p)), r.slideShadows) {
                  let e = n ? t.querySelector(".swiper-slide-shadow-left") : t.querySelector(".swiper-slide-shadow-top"),
                     s = n ? t.querySelector(".swiper-slide-shadow-right") : t.querySelector(".swiper-slide-shadow-bottom");
                  e || (e = ie("coverflow", t, n ? "left" : "top")), s || (s = ie("coverflow", t, n ? "right" : "bottom")), e && (e.style.opacity = p > 0 ? p : 0), s && (s.style.opacity = -p > 0 ? -p : 0)
               }
            }
         },
         setTransition: e => {
         ...
         setTranslate: () => {
            ...
            for (let s = 0; s < e.length; s += 1) {
               ...
               if (h && f.shadow || !h) {
                  ...
                  if (!e && f.shadow && (e = ie("creative", a)), e) {
         ...
         setTranslate: () => {
            ...
            for (let o = 0; o < e.length; o += 1) {
               ...
               if (i.slideShadows) {
                  ...
                  e || (e = ie("cards", d)), e && (e.style.opacity = Math.min(Math.max((Math.abs(p) - .5) / .5, 0), 1))
               }
               d.style.zIndex = -Math.abs(Math.round(c)) + e.length, se(0, d).style.transform = S
            }
         },
         setTransition: e => {
            const s = t.slides.map(e => m(e));
